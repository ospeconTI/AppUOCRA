...
export class gremioMapaScreen extends connect(store, SECCIONALES_DATOS, MAPA_CLICK, MEDIA_CHANGE, SCREEN)(LitElement) {
	constructor() {
		super();
		this.hidden = true;
		this.area = "body";
	...
	stateChanged(state, name) {
		if (name == SCREEN || name == MEDIA_CHANGE) {
			...
			const SeMuestraEnUnasDeEstasPantallas = "-gremioMapa-".indexOf("-" + state.screen.name + "-") != -1;
...
window.customElements.define("gremiomapa-screen", gremioMapaScreen);
