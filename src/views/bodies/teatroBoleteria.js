...
export class teatroBoleteriaScreen extends connect(store, PROGRAMACION_DATOS, MEDIA_CHANGE, SCREEN)(LitElement) {
	constructor() {
		super();
		this.hidden = true;
		this.area = "body";
                            ...
                            return html` 
                                ...
                                <div class="grid notas" style="align-items: stretch;">
                                    ...
                                    <div class="grid row" style="grid-gap:0" >
                                        ...
                                        <div class="notaDetTxt">${(new Date(item.fecha)).getHours() + ":" + (new Date(item.fecha)).getMinutes() + "hs. - " + (item.valor==0 ? this.gremioBoleteria[this.idioma].entradaLibre : this.gremioBoleteria[this.idioma].entradaPaga + item.valor)}</div>                                            
                                    </div>
                                </div>
