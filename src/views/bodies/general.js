...
export class generalScreen extends connect(
    store,
    ITEMS_BOTONITEM,
    MENUES_ERRORTIMESTAMP,
    ITEMS_ERRORTIMESTAMP,
    LEYENDAS_ERRORTIMESTAMP,
    TITULO_ERRORTIMESTAMP,
    BANNERS_ERRORTIMESTAMP,
    CURRENT_TIMESTAMP,
    LEYENDAS_TIMESTAMP,
    MENUES_TIMESTAMP,
    BANNERS_TIMESTAMP,
    ...
    render() {
        if (this.banner && this.item && this.leyenda && this.titulo && this.menu) {
            ...
            const es =
                "-sindicato-cultura-tv-moecra-salud-saludSeguridad-ivt-cine-adolecencia-adicciones-hogar-mujeres-arte-deportes-beneficios-turismo-".indexOf("-" + store.getState().screen.name + "-") !=
                -1;
    ...
    stateChanged(state, name) {
        ...
        if (name == SCREEN || name == MEDIA_CHANGE) {
            ...
            const SeMuestraEnUnasDeEstasPantallas =
                "-sindicato-cultura-tv-moecra-salud-saludSeguridad-ivt-cine-adolecencia-adicciones-hogar-mujeres-arte-deportes-beneficios-turismo-fundacion-".indexOf("-" + state.screen.name + "-") !=
                -1;
