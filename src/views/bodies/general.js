...
export class generalScreen extends connect(store, ITEMS_BOTONITEM, MENUES_ERRORTIMESTAMP, ITEMS_ERRORTIMESTAMP, LEYENDAS_ERRORTIMESTAMP, TITULO_ERRORTIMESTAMP, BANNERS_ERRORTIMESTAMP, CURRENT_TIMESTAMP, LEYENDAS_TIMESTAMP, MENUES_TIMESTAMP, BANNERS_TIMESTAMP, ITEMS_TIMESTAMP, TITULO_TIMESTAMP, MEDIA_CHANGE, SCREEN)(LitElement) {
	...
	botonItem(que) {
		...
		if (!usu & (que == "mujeres" || que == "adicciones" || que == "adolecencia" || que == "turismo" || que == "deportes" || que == "beneficiosSeguros" || que == "beneficiosJubilacion" || que == "beneficiosJubilacion" || que == "beneficiosJubilacion")) {
			store.dispatch(
				showConfirmacion(
	...
	redireccionar(usu, que) {
		var msg = "";
		if (usu) {
			msg = "Nombre: " + usu.nombre + ".%0D%0A" + "Apellido: " + usu.apellido + ". %0D%0ADocumento: " + usu.documento;
		}
		switch (que) {
			case "mujeres":
				//app.uocra.org@gmail.com
				location.href = "mailto:generos@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Mujeres&body=" + msg;
				break;
			case "adicciones":
				//app.uocra.org@gmail.com
				location.href = "mailto:prevencionadicciones@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Adicciones&body=" + msg;
				break;
			case "turismo":
				//app.uocra.org@gmail.com
				location.href = "mailto:turismo@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Turismo&body=" + msg;
				break;
			case "adolecencia":
				//app.uocra.org@gmail.com
				location.href = "mailto:adolescencia@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Adolescencia&body=" + msg;
				break;
			case "deportes":
				//app.uocra.org@gmail.com
				location.href = "mailto:turismo@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Deportes&body=" + msg;
				break;
			case "beneficiosJubilacion":
				//app.uocra.org@gmail.com
				location.href = "mailto:agarcia@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Beneficios%20jubilatorios&body=" + msg;
				break;
			case "beneficiosSeguros":
				//app.uocra.org@gmail.com
				location.href = "mailto:agarcia@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Seguro%20de%20vida&body=" + msg;
				break;
			case "beneficiosSepelios":
				//app.uocra.org@gmail.com
				location.href = "mailto:agarcia@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Sepelios&body=" + msg;
				break;
			case "beneficiosSubsidios":
				//app.uocra.org@gmail.com
				location.href = "mailto:agarcia@uocra.org?cc=app.uocra.org@gmail.com&subject=UOCRA%20Subsidios&body=" + msg;
				break;
			case "salud":
				document.location.href = "tel:0800-222-0123";
				//location.href = "https://api.whatsapp.com/send?phone=+5491136623055&text=Afiliacion";
				//window.open("https://api.whatsapp.com/send?phone=+5491136623055&text=Afiliacion");
				break;
			case "saludCovid":
				//location.href = "https://api.whatsapp.com/send?phone=+5491136623055&text=Afiliacion";
			...
			case "beneficiosSegurosAdicionales":
				window.open("https://www.uocra.org/pdf/SeguroVidaColectivo.pdf ", "_blank");
				break;
			case "TeatroComunicate":
				//location.href = "https://api.whatsapp.com/send?phone=+5491136623055&text=Afiliacion";
				window.open("https://api.whatsapp.com/send?phone=+5491173657509&text=Teatro");
				break;
