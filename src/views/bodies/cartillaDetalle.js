...
export class cartillaDetalleScreen extends connect(store, MEDIA_CHANGE, SCREEN)(LitElement) {
		...
		if (true) {
			return html`
				<div id="cuerpo" class="grid row">
					...
					<div id="subTituloTexto">El <b>Sanatorio Franchín</b> nació con el fin de brindarle al Trabajador Constructor un Sistema de Salud según sus necesidades. Es un sanatorio de excelencia, líder en la defensa de la salud y equipado con la más moderna tecnológica.</div>
	...
	stateChanged(state, name) {
		if (name == SCREEN || name == MEDIA_CHANGE) {
			...
			const SeMuestraEnUnasDeEstasPantallas = "-cartillaDetalle-".indexOf("-" + state.screen.name + "-") != -1;
...
window.customElements.define("cartilladetalle-screen", cartillaDetalleScreen);
