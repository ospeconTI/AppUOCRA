...
export class turismoMapaScreen extends connect(store, HOTELES_DATOS, MAPA_CLICK, MEDIA_CHANGE, SCREEN)(LitElement) {
	constructor() {
		super();
		this.hidden = true;
		this.area = "body";
	...
	render() {
		if (this.centros && this.current=="turismoMapa") { return html`
			<div id="cuerpo">
				<div id="titulo">
