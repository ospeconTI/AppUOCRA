...
export class beneficiosSegurosScreen extends connect(store, MEDIA_CHANGE, SCREEN)(LitElement) {
	constructor() {
        ...
        this.item = [
            {Id:1,titulo:"TIPOS DE SEGUROS DE VIDA", cuerpo: "<p><li>Subsidio para prenatal de 6 meses.</li></p><p><li>Subsidio por nacimiento.</li></p><p><li>Subsidio para transporte escolar.</li></p><p><li>Subsidio para Guardería.</li></p><p><li>Subsidios para Colonia de Vacaciones.</li></p>"},
