...
export class registroMensajeScreen extends connect(store, MEDIA_CHANGE, SCREEN)(LitElement) {
    constructor() {
        ...
        this.registroMensaje = require("../../../assets/idiomas/registroMensaje.json");
    }
    ...
    render() {
        return html`
            ...
            <div id="titulo">${this.registroMensaje[this.idioma].titulo1}</div>
            <div id="subtitulo">
                <label id="leyenda"> ${this.registroMensaje[this.idioma].titulo2} </label>
                <label id="detalle"> ${this.registroMensaje[this.idioma].titulo3} </label>
            </div>
        `;
    }
