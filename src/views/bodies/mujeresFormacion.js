...
export class mujeresFormacionScreen extends connect(store, MUJERESVIDEOS_DATOS, MUJERESVIDEOS_eRROR, MEDIA_CHANGE, SCREEN)(LitElement) {
	constructor() {
		...
		this.idiomaLista = require('../../../assets/idiomas/mujeresFormacion.json');
        this.registros = null
	...
	render() {
		if (this.registros) { return html`
			<div id="cuerpo">
                ...
                <div class="notaDetTxt" style="padding: 1vh 4vw 0 4vw;">
                     ${unsafeHTML(this.idiomaLista[this.idioma].descripcion)}
                </div>
				<div class="panel">
...
window.customElements.define("mujeresformacion-screen", mujeresFormacionScreen);
