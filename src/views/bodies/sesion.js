...
export class sesionScreen extends connect(store, CON_CREDENCIAL_SINDICAL_OK, CON_CREDENCIAL_SINDICAL_ERROR, MEDIA_CHANGE, SCREEN)(LitElement) {
	constructor() {
		super();
		this.hidden = true;
		this.area = "body";
	...
	stateChanged(state, name) {
		...
		if (name == CON_CREDENCIAL_SINDICAL_OK && state.screen.name == "sesion") {
			store.dispatch(goHistoryPrev());
		}
		if (name == CON_CREDENCIAL_SINDICAL_ERROR && state.screen.name == "sesion") {
			store.dispatch(goHistoryPrev());
		}
	}
