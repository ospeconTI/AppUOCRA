            ...
            return html`
                <div id="cuerpo" class="grid row" style="grid-gap:0rem">
                    ...
                    <div id="tituloTexto" class="grid">
                        ...
                        <div id="solicitud" style="color:var(--primary-color)">
                            ${this.idiomaGenerico[this.idioma].diasLargo[new Date(this.reserva.fecha).getDay()] +
                            " " +
                            new Date(this.reserva.fecha).getDate() +
                            " de " +
                            this.idiomaGenerico[this.idioma].mesLargo[new Date(this.reserva.fecha).getMonth()] +
                            " - " +
                            new Date(this.reserva.fecha).getHours() +
                            ":" +
                            new Date(this.reserva.fecha).getMinutes() +
                            "hs."}
                        </div>
                    </div>
