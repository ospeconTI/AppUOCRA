...
import { msgAceptaCoberturaComponent } from "../views/componentes/msgAceptaCobertura";
...
import { gremioCredencialScreen } from "./bodies/gremioCredencial";
...
import { covidScreen } from "./bodies/covid";
import { afiliacionSindicalScreen } from "./bodies/afiliacionSindical";
...
export class viewManager extends connect(store, MEDIA_CHANGE, SCREEN, SELECTION)(LitElement) {
	...
	render() {
		return html`
			...
			<gremiocredencial-screen id="gremioCredencial" class="body"></gremiocredencial-screen>
			...
			<afiliacionsindical-screen id="afiliacionSindical" class="body"></afiliacionsindical-screen>
			...
			<covid-screen id="covid" class="body"></covid-screen>
