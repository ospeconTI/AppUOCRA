import { GET, GET_SUCCESS, GET_ERROR, ADD, ADD_SUCCESS, ADD_ERROR, UPDATE, UPDATE_SUCCESS, UPDATE_ERROR, PATCH, PATCH_SUCCESS, PATCH_ERROR, REMOVE, REMOVE_SUCCESS, REMOVE_ERROR } from "../cineEdicionesActuales/action";
...
export const get =
	...
	(action) => {
		next(action);
		if (action.type === GET) {
			fetchJSON(dispatch, "cineEdicionesActuales.json", GET_SUCCESS, GET_ERROR);
		}
	};
