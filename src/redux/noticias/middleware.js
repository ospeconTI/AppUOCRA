...
export const get = ({
    ...
    if (action.type === GET) {
        let noticias = [
            {id:1, imagen:"https://app.uocra.org/noticias/irupe.gif", copete:'UOCRA Cultura despide su temporada 2020 con un show en Streaming, 28 de noviembre a las 20 hs, no te pierdas a Irupé Tarragó Ros en concierto.",nota:"UOCRA Cultura despide su temporada 2020 con un show en Streaming, 28 de noviembre a las 20 hs, no te pierdas a Irupé Tarragó Ros en concierto.', orden: 1},
            {id:2, imagen:"https://app.uocra.org/noticias/gm.gif", copete:'Gerardo Martínez, presidente de UOCRA, firmo un acuerdo con el Banco Nación por créditos para la compra de motos.",nota:"Gerardo Martínez, presidente de UOCRA, firmo un acuerdo con el Banco Nación por créditos para la compra de motos.', orden: 2},
            {id:3, imagen:"https://app.uocra.org/noticias/maradona.gif", copete:'Construir TV presenta “60 veces Diego”, semana homenaje a Diego Maradona.",nota:"Construir TV presenta “60 veces Diego”, semana homenaje a Diego Maradona.', orden: 3},
            {id:4, imagen:"https://app.uocra.org/noticias/adicciones.gif", copete:'Prevención de Adicciones, finalizó su 4ta. Jornada Internacional sobre la Problemática de las Adicciones en el mundo laboral.",nota:"Prevención de Adicciones, finalizó su 4ta. Jornada Internacional sobre la Problemática de las Adicciones en el mundo laboral.', orden: 4},
        ]
