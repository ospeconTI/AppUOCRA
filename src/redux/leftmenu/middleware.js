...
export const get = ({
    ...
    if (action.type === GET) {
        let leftmenu = [
            ...
            {id:13,nombre:"ADOLECENCIA",imagen: 'ADOLECENCIA' ,accion:"moecra"},
            {id:14,nombre:"ADICCIONES",imagen: 'ADICCIONES' ,accion:"moecra"},
            {id:15,nombre:"HOGAR",imagen: 'HOGAR' ,accion:"ivt"},
            {id:16,nombre:"SEGURIDAD",imagen: 'SEGURIDAD' ,accion:"saludSeguridad"},
            {id:17,nombre:"MUJERES",imagen: 'MUJERES' ,accion:"moecra"},
