import {
    ...
    REMOVE_ERROR,
    EDIT,
    FUNDACION_ESPECIALIDAD
} from "../fundacionEspecialidades/actions";
...
const initialState = {
    ...
    editTimeStamp: null,
    fundacionEspecialidad: null,
    fundacionEspecialidadTimeStamp: null,
};
...
export const reducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case ADD_ERROR:
            ...
            break;
        case FUNDACION_ESPECIALIDAD:
            newState.fundacionEspecialidad = action.registro;
            newState.fundacionEspecialidadTimeStamp = (new Date()).getTime();
            break;
    }
    return newState;
};